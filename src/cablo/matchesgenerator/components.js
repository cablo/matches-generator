    ...
    return <div className="form-line">
        {
            ...
            <React.Fragment>
                ...
                <button disabled={props.playerName.length === 0} type="submit" className="btn btn-primary button-add" onClick={props.onPlayerAdd}>Add</button>
            </React.Fragment>
        }
        {
            !props.isEditing &&
        ...
        <button className="btn btn-danger button-start-stop" onClick={props.onStartStop}>{props.isEditing ? 'Start!' : 'Stop!'}</button>
    </div>
};
...
const stateTable = ['&nbsp;&nbsp;:&nbsp;&nbsp;', '0&nbsp;:&nbsp;0', '1&nbsp;:&nbsp;0', '0&nbsp;:&nbsp;1'];

export const MatchesTable = (props) => {
    return <div className="table-scroll-wrap">
                ...
                props.matches.map((match, i) =>
                    <tr key={i}>
                        ...
                        <td className="col-state">
                            <button disabled={props.isEditing} className="btn btn-primary button-state" onClick={e => props.onMatchChange(i)} dangerouslySetInnerHTML={{__html: stateTable[match.state]}}></button>
                        </td>
